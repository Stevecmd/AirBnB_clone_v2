...
(venv) stevecmd@DESKTOP-UTB295U:~$ curl 0.0.0.0:5000 ; echo "" | cat -e
Hello HBNB!$
...
(venv) stevecmd@DESKTOP-UTB295U:~$ curl 0.0.0.0:5000/c/is_fun ; echo "" | cat -e
C is fun$
(venv) stevecmd@DESKTOP-UTB295U:~$ curl 0.0.0.0:5000/c/cool ; echo "" | cat -e
C cool$
(venv) stevecmd@DESKTOP-UTB295U:~$ curl 0.0.0.0:5000/c
...
In another tab:
```sh
(venv) stevecmd@DESKTOP-UTB295U:~$ curl -Ls 0.0.0.0:5000/python/is_magic ; echo "" | cat -e
Python is magic$
(venv) stevecmd@DESKTOP-UTB295U:~$ curl -Ls 0.0.0.0:5000/python ; echo "" | cat -e
Python is cool$
(venv) stevecmd@DESKTOP-UTB295U:~$ curl -Ls 0.0.0.0:5000/python/ ; echo "" | cat -e
Python is cool$
...
(venv) stevecmd@DESKTOP-UTB295U:~$ curl 0.0.0.0:5000/number/89 ; echo "" | cat -e
89 is a number$
(venv) stevecmd@DESKTOP-UTB295U:~$ curl 0.0.0.0:5000/number/8.9 
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
<title>404 Not Found</title>
<h1>Not Found</h1>
<p>The requested URL was not found on the server.  If you entered the URL manually please check your spelling and try again.</p>
(venv) stevecmd@DESKTOP-UTB295U:~$ curl 0.0.0.0:5000/number/python 
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
<title>404 Not Found</title>
<h1>Not Found</h1>
<p>The requested URL was not found on the server.  If you entered the URL manually please check your spelling and try again.</p>
...
In another tab:
```sh
(venv) stevecmd@DESKTOP-UTB295U:~$ curl 0.0.0.0:5000/number_template/89 ; echo ""
<!DOCTYPE html>
<HTML lang="en">
    <HEAD>
        <TITLE>HBNB</TITLE>
...
(venv) stevecmd@DESKTOP-UTB295U:~$ curl 0.0.0.0:5000/number_template/8.9 
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
<title>404 Not Found</title>
<h1>Not Found</h1>
<p>The requested URL was not found on the server.  If you entered the URL manually please check your spelling and try again.</p>
(venv) stevecmd@DESKTOP-UTB295U:~$ curl 0.0.0.0:5000/number_template/python 
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
<title>404 Not Found</title>
<h1>Not Found</h1>
<p>The requested URL was not found on the server.  If you entered the URL manually please check your spelling and try again.</p>
...
(venv) stevecmd@DESKTOP-UTB295U:~$ curl 0.0.0.0:5000/number_odd_or_even/89 ; echo ""
<!DOCTYPE html>
<HTML lang="en">
    <HEAD>
        <TITLE>HBNB</TITLE>
...
(venv) stevecmd@DESKTOP-UTB295U:~$ curl 0.0.0.0:5000/number_odd_or_even/32 ; echo ""
<!DOCTYPE html>
<HTML lang="en">
    <HEAD>
        <TITLE>HBNB</TITLE>
...
(venv) stevecmd@DESKTOP-UTB295U:~$ curl 0.0.0.0:5000/number_odd_or_even/python 
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
<title>404 Not Found</title>
<h1>Not Found</h1>
<p>The requested URL was not found on the server.  If you entered the URL manually please check your spelling and try again.</p>
...
(venv) stevecmd@DESKTOP-UTB295U:~$ curl 0.0.0.0:5000/states_list ; echo ""
<!DOCTYPE html>
<HTML lang="en">
    <HEAD>
        <TITLE>HBNB</TITLE>
...
(venv) stevecmd@DESKTOP-UTB295U:~$ curl 0.0.0.0:5000/cities_by_states ; echo ""
<!DOCTYPE html>
<HTML lang="en">
    <HEAD>
        <TITLE>HBNB</TITLE>
...
(venv) stevecmd@DESKTOP-UTB295U:~$ curl 0.0.0.0:5000/states ; echo ""
<!DOCTYPE html>
<HTML lang="en">
    <HEAD>
        <TITLE>HBNB</TITLE>
...
(venv) stevecmd@DESKTOP-UTB295U:~$ curl 0.0.0.0:5000/states/421a55f4-7d82-47d9-b54c-a76916479552 ; echo ""
<!DOCTYPE html>
<HTML lang="en">
    <HEAD>
        <TITLE>HBNB</TITLE>
...
(venv) stevecmd@DESKTOP-UTB295U:~$ curl 0.0.0.0:5000/states/holberton ; echo ""
<!DOCTYPE html>
<HTML lang="en">
    <HEAD>
        <TITLE>HBNB</TITLE>
...
- Routes:
    - `/hbnb`: display a HTML page like `8-index.html`, done during the `0x01. AirBnB clone - Web static` project
        - Copy files `3-footer.css`, `3-header.css`, `4-common.css`, `6-filters.css` and `8-places.css` from w`eb_static/styles/` to the folder `web_flask/static/styles`
